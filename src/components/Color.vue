<template>
  <div class="layout">
    <div v-for="color in colors" :key="color.name" class="card">
  ...
  data() {
    return {
      colors: [
        ...
        { name: 'red apple', hex: '#c53121', category: 'fruit' },
        { name: 'green apple', hex: '#71ba07', category: 'fruit' },
        { name: 'yellow apple', hex: '#fbd333', category: 'fruit' },
